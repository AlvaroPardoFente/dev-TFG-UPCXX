...
class UpcxxAllGatherBroadcast : public UpcxxBenchmarkScheme
{
public:
    ...
    void init(int argc, char *argv[]) override
    {
        ...
        // Result vector
        result = upcxx::new_array<uint32_t>(nums_per_rank * world_size);
        result_l = result.local();
    ...
    void benchmark_body() override
    {
        ...
        upcxx::broadcast(result_l, nums_per_rank * world_size, 0).wait();
    }
