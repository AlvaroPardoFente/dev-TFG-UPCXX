...
data.mpi_1N_2n = importtable(base_path + "mpi_reduce_all_1N_2n");
data.mpi_2N_4n = importtable(base_path + "mpi_reduce_all_2N_4n");
data.mpi_4N_8n = importtable(base_path + "mpi_reduce_all_4N_8n");
data.mpi_6N_12n = importtable(base_path + "mpi_reduce_all_6N_12n");
data.mpi_8N_16n = importtable(base_path + "mpi_reduce_all_8N_16n");
data.mpi_10N_20n = importtable(base_path + "mpi_reduce_all_10N_20n");
data.mpi_12N_24n = importtable(base_path + "mpi_reduce_all_12N_24n");

data.upcxx_1N_2n = importtable(base_path + "upcxx_reduce_all_1N_2n");
data.upcxx_2N_4n = importtable(base_path + "upcxx_reduce_all_2N_4n");
data.upcxx_4N_8n = importtable(base_path + "upcxx_reduce_all_4N_8n");
data.upcxx_6N_12n = importtable(base_path + "upcxx_reduce_all_6N_12n");
data.upcxx_8N_16n = importtable(base_path + "upcxx_reduce_all_8N_16n");
data.upcxx_10N_20n = importtable(base_path + "upcxx_reduce_all_10N_20n");
data.upcxx_12N_24n = importtable(base_path + "upcxx_reduce_all_12N_24n");

data.upcxx_broadcast_1N_2n = importtable(base_path + "upcxx_reduce_broadcast_1N_2n");
data.upcxx_broadcast_2N_4n = importtable(base_path + "upcxx_reduce_broadcast_2N_4n");
data.upcxx_broadcast_4N_8n = importtable(base_path + "upcxx_reduce_broadcast_4N_8n");
data.upcxx_broadcast_6N_12n = importtable(base_path + "upcxx_reduce_broadcast_6N_12n");
data.upcxx_broadcast_8N_16n = importtable(base_path + "upcxx_reduce_broadcast_8N_16n");
data.upcxx_broadcast_10N_20n = importtable(base_path + "upcxx_reduce_broadcast_10N_20n");
data.upcxx_broadcast_12N_24n = importtable(base_path + "upcxx_reduce_broadcast_12N_24n");
...
% 
% if (do_print)
%     print("upcxx_reduce_all_3D", "-dpng");
% end
% 
% hold off;
...
hold on
plot(unique_sizes_bytes, bandwidth_mean.upcxx_broadcast_1N_2n, "--x")
set(gca, "XScale", "log")
set(gca, "YScale", "log")
ax = gca;
ax.XTick = unique_sizes_bytes;
ax.XTickLabel = size_tick_labels;
min_bandwidth = min(min([bandwidth_mean.mpi_1N_2n, bandwidth_mean.upcxx_broadcast_1N_2n]));
max_bandwidth = max(max([bandwidth_mean.mpi_1N_2n, bandwidth_mean.upcxx_broadcast_1N_2n]));
...
%nexttile
plot(unique_sizes_bytes, bandwidth_mean.upcxx_2N_4n, "--o")
hold on
...
ax.XTick = unique_sizes_bytes;
ax.XTickLabel = size_tick_labels;
min_bandwidth = min(min([bandwidth_mean.upcxx_2N_4n, bandwidth_mean.upcxx_broadcast_2N_4n]));
max_bandwidth = max(max([bandwidth_mean.upcxx_2N_4n, bandwidth_mean.upcxx_broadcast_2N_4n]));
ax.YTick = get_ytick_range(min_bandwidth, max_bandwidth);
remove_m_ticks();
...
if (do_print)
    print("upcxx_reduce_all_2N_4n", "-dpng");
end

difference_2N = abs(bandwidth_mean.upcxx_2N_4n ./ bandwidth_mean.upcxx_broadcast_2N_4n);
dispmaxdiff('[2N, reduce_all]', difference_2N, size_tick_labels)
...
ax.XTick = unique_sizes_bytes;
ax.XTickLabel = size_tick_labels;
min_bandwidth = min(min([bandwidth_mean.mpi_2N_4n, bandwidth_mean.upcxx_broadcast_2N_4n]));
max_bandwidth = max(max([bandwidth_mean.mpi_2N_4n, bandwidth_mean.upcxx_broadcast_2N_4n]));
ax.YTick = get_ytick_range(min_bandwidth, max_bandwidth);
remove_m_ticks();
...
if (do_print)
    print("reduce_all_2N_4n", "-dpng");
end

difference_2N = abs(bandwidth_mean.mpi_2N_4n ./ bandwidth_mean.upcxx_broadcast_2N_4n);
dispmaxdiff('[2N, mpi]', difference_2N, size_tick_labels)

difference_2N_upcxx = abs(bandwidth_mean.upcxx_broadcast_2N_4n ./ bandwidth_mean.mpi_2N_4n);
...
hold on
plot(unique_sizes_bytes, bandwidth_mean.upcxx_broadcast_4N_8n, "--x")
set(gca, "XScale", "log")
set(gca, "YScale", "log")
ax = gca;
ax.XTick = unique_sizes_bytes;
ax.XTickLabel = size_tick_labels;
min_bandwidth = min(min([bandwidth_mean.mpi_4N_8n, bandwidth_mean.upcxx_broadcast_4N_8n]));
max_bandwidth = max(max([bandwidth_mean.mpi_4N_8n, bandwidth_mean.upcxx_broadcast_4N_8n]));
ax.YTick = get_ytick_range(min_bandwidth, max_bandwidth);
remove_m_ticks();
...
if (do_print)
    print("reduce_all_16KB_all", "-dpng");
end
